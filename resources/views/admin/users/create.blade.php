        ...
        <div class="col-lg-12">
            <div class="card ">
                ...
                <div class="card-body">
                        ...
                        {!! Form::open(['action' => 'AdminUserController@store','method'=>'POST','files'=>true, 'class'=>"form-horizontal"]) !!}
                        <div class="form-body">
                            <div class="card-header bg-teal">
                                <h3 class="m-b-0 text-white">Create User Priviledge</h3>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group row">
                                        {!! Form::label('password', 'Password: ', ['class' => 'control-label text-right col-md-3']); !!}
                                        <div class="col-md-9">
